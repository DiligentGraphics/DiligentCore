...
### Building Diligent Engine seperately

The following is a very rough guide of building Diligent seperately to then be used in your own project.
...
- `SDL_GetDisplayModes()` can be used to determine max resolution.
