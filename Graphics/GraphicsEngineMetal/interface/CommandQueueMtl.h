...
DILIGENT_BEGIN_INTERFACE(ICommandQueueMtl, IObject)
{
...
#    define ICommandQueueMtl_GetNextFenceValue(This)      CALL_IFACE_METHOD(CommandQueueD3D12, GetNextFenceValue,     This)
#    define ICommandQueueMtl_GetMtlCommandQueue(This)     CALL_IFACE_METHOD(CommandQueueD3D12, GetMtlCommandQueue,    This)
#    define ICommandQueueMtl_GetCompletedFenceValue(This) CALL_IFACE_METHOD(CommandQueueD3D12, GetCompletedFenceValue,This)
#    define ICommandQueueMtl_WaitForIdle(This)            CALL_IFACE_METHOD(CommandQueueD3D12, WaitForIdle,           This)
#    define ICommandQueueMtl_Submit(This, ...)            CALL_IFACE_METHOD(CommandQueueD3D12, Submit,                This, __VA_ARGS__)
