...
#define INIT_TEX_VIEW_FORMAT_INFO(TexFmt, SRVFmt, RTVFmt, DSVFmt, UAVFmt)\
        ...
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_BC1_TYPELESS,            BC1_UNORM,      UNKNOWN, UNKNOWN, UNKNOWN);
        ...
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_BC2_TYPELESS,            BC2_UNORM,      UNKNOWN, UNKNOWN, UNKNOWN);
        ...
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_BC3_TYPELESS,            BC3_UNORM,      UNKNOWN, UNKNOWN, UNKNOWN);
        ...
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_BGRX8_TYPELESS,          BGRX8_UNORM,      BGRX8_UNORM,      UNKNOWN, BGRX8_UNORM);
        ...
        INIT_TEX_VIEW_FORMAT_INFO(TEX_FORMAT_BC7_TYPELESS,            BC7_UNORM,      UNKNOWN, UNKNOWN, UNKNOWN);
