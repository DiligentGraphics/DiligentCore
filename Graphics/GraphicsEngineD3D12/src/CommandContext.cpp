...
void CommandContext::TransitionResource(TextureD3D12Impl& TexD3D12, RESOURCE_STATE NewState)
{
    ...
    TransitionResource(TexD3D12, StateTransitionDesc{&TexD3D12, RESOURCE_STATE_UNKNOWN, NewState, RESOURCE_STATE_FLAG_UPDATE_STATE});
}
...
void CommandContext::TransitionResource(BufferD3D12Impl& BuffD3D12, RESOURCE_STATE NewState)
{
    ...
    TransitionResource(BuffD3D12, StateTransitionDesc{&BuffD3D12, RESOURCE_STATE_UNKNOWN, NewState, RESOURCE_STATE_FLAG_UPDATE_STATE});
}
...
void CommandContext::TransitionResource(BottomLevelASD3D12Impl& BlasD3D12, RESOURCE_STATE NewState)
{
    ...
    TransitionResource(BlasD3D12, StateTransitionDesc{&BlasD3D12, RESOURCE_STATE_UNKNOWN, NewState, RESOURCE_STATE_FLAG_UPDATE_STATE});
}
...
void CommandContext::TransitionResource(TopLevelASD3D12Impl& TlasD3D12, RESOURCE_STATE NewState)
{
    ...
    TransitionResource(TlasD3D12, StateTransitionDesc{&TlasD3D12, RESOURCE_STATE_UNKNOWN, NewState, RESOURCE_STATE_FLAG_UPDATE_STATE});
}
...
{
    if ((m_Barrier.Flags & RESOURCE_STATE_FLAG_DISCARD_CONTENT) == 0)
        return;
    ...
    if (d3d12CmdListType == D3D12_COMMAND_LIST_TYPE_COMPUTE)
    {
...
void StateTransitionHelper::operator()(ResourceType& Resource)
{
    ...
    if ((m_OldState & m_Barrier.NewState) != m_Barrier.NewState)
    {
        ...
        if ((m_Barrier.Flags & RESOURCE_STATE_FLAG_UPDATE_STATE) != 0)
        {
