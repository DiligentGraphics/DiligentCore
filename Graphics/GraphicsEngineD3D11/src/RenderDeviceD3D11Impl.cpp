...
IMPLEMENT_QUERY_INTERFACE(RenderDeviceD3D11Impl, IID_IRenderDeviceD3D11, TRenderDeviceBase)
...
void RenderDeviceD3D11Impl::CreateTexture1DFromD3DResource(ID3D11Texture1D* pd3d11Texture, RESOURCE_STATE InitialState, ITexture** ppTexture)
{
    ...
    CreateDeviceObject("texture", TexDesc, ppTexture,
                       [&]() //
                       {
                           ...
                           pTextureD3D11->QueryInterface(IID_ITexture, reinterpret_cast<IObject**>(ppTexture));
