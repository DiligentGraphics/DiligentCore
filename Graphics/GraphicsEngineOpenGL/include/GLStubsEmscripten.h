...
#define glGenProgramPipelines(...)    UnsupportedGLFunctionStub("glGenProgramPipelines")
#define glBindProgramPipeline(...)    UnsupportedGLFunctionStub("glBindProgramPipeline")
#define glDeleteProgramPipelines(...) UnsupportedGLFunctionStub("glDeleteProgramPipelines")
#define glUseProgramStages(...)       UnsupportedGLFunctionStub("glUseProgramStages")
