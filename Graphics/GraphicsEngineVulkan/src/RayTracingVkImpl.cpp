...
void ShaderBindingTableVkImpl::BindRayGenShader(const char* ShaderGroupName)
{
    // AZ TODO
}
...
void ShaderBindingTableVkImpl::BindMissShader(const char* ShaderGroupName, Uint32 MissIndex)
{
    // AZ TODO
}
