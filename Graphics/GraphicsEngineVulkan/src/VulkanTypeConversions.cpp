...
static_assert(PIPELINE_STAGE_FLAG_FRAGMENT_SHADER              == VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,                 "PIPELINE_STAGE_FLAG_FRAGMENT_SHADER != VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT");
