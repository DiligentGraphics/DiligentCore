...
void DeviceContextVkImpl::BuildTLAS(const TLASBuildAttribs& Attribs)
{
    ...
    // copy instance data into instance buffer
    {
        ...
        UpdateBufferRegion(pInstancesVk, Attribs.InstancesBufferOffset, Size, TmpSpace.vkBuffer, TmpSpace.AlignedOffset, Attribs.InstancesBufferTransitionMode);
    }
    TransitionOrVerifyBufferState(*pInstancesVk, Attribs.InstancesBufferTransitionMode, RESOURCE_STATE_BUILD_AS_READ, VkAccessFlagBits(0), OpName);
