...
public:
    ...
    /// Implementation of IDeviceContext::ExecuteSuperResolution() in WebGPU backend.
    void DILIGENT_CALL_TYPE ExecuteSuperResolution(const ExecuteSuperResolutionAttribs& Attribs,
