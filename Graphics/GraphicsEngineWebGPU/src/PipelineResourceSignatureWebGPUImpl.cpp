    ...
    TPipelineResourceSignatureBase{pRefCounters, pDevice, Desc, ShaderStages, bIsDeviceInternal}
{
    ...
    //        [this]() //
    //        {
    //            return ShaderResourceCacheWebGPU::GetRequiredMemorySize(m_ResourceCount);
    //        });
    //}
    //catch (...)
    //{
...
void PipelineResourceSignatureWebGPUImpl::CopyStaticResources(ShaderResourceCacheWebGPU& ResourceCache) const
{
    // TODO: Implement
}
...
void PipelineResourceSignatureWebGPUImpl::CreateLayout(bool IsSerialized)
{
}

void PipelineResourceSignatureWebGPUImpl::Destruct()
{
    PipelineResourceSignatureBase::Destruct();
}
