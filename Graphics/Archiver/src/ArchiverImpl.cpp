                       ...
                       std::array<const char*, MAX_RESOURCE_SIGNATURES>& PRSNames)
{
    ...
    PSOSerializer<Mode>::SerializePSOData(Ser, PSOCreateInfo, PRSNames, nullptr, RPName);
}
...
void SerializerPSOImpl(Serializer<Mode>&                                 Ser,
                       ...
                       std::array<const char*, MAX_RESOURCE_SIGNATURES>& PRSNames)
{
    PSOSerializer<Mode>::SerializePSOData(Ser, PSOCreateInfo, PRSNames, nullptr);
}
                       ...
                       std::array<const char*, MAX_RESOURCE_SIGNATURES>& PRSNames)
{
    ...
    PSOSerializer<Mode>::SerializePSOData(Ser, PSOCreateInfo, PRSNames, nullptr, RemapShaders);
}
