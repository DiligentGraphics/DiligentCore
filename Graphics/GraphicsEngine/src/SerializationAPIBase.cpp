...
void SerializationAPIBase::CreateArchiveSourceFromFile(const Char* Path, IArchiveSource** ppSource)
{
    ...
    *ppSource = nullptr;
    try
    {
        ...
        auto* pSourceImpl(NEW_RC_OBJ(RawMemAllocator, "Archive source instance", ArchiveFileSourceImpl)(Path));
        pSourceImpl->QueryInterface(IID_ArchiveSource, reinterpret_cast<IObject**>(ppSource));
    }
    catch (...)
    {
...
void SerializationAPIBase::CreateArchiveSourceFromBlob(IDataBlob* pBlob, IArchiveSource** ppSource)
{
    ...
    *ppSource = nullptr;
    ...
    {
        auto& RawMemAllocator = GetRawAllocator();
        auto* pSourceImpl(NEW_RC_OBJ(RawMemAllocator, "Archive source instance", ArchiveMemSourceImpl)(pBlob));
        pSourceImpl->QueryInterface(IID_ArchiveSource, reinterpret_cast<IObject**>(ppSource));
    }
    catch (...)
    {
