...
// {61B29313-47AA-4538-A287-7A4759D6E125}
static const INTERFACE_ID IID_ShaderResourceBinding2 =
    {0x61b29313, 0x47aa, 0x4538, {0xa2, 0x87, 0x7a, 0x47, 0x59, 0xd6, 0xe1, 0x25}};
...
#define DILIGENT_INTERFACE_NAME IShaderResourceBinding2
#include "../../../Primitives/interface/DefineInterfaceHelperMacros.h"

#define IShaderResourceBinding2InclusiveMethods \
    IObjectInclusiveMethods;                    \
    IShaderResourceBinding2Methods ShaderResourceBinding2

/// Shader resource binding interface
DILIGENT_BEGIN_INTERFACE(IShaderResourceBinding2, IObject)
{
    /// Returns pointer to the referenced buffer object.

    /// The method calls AddRef() on the returned interface,
    /// so Release() must be called to avoid memory leaks.
    VIRTUAL struct IPipelineState2* METHOD(GetPipelineState)(THIS) PURE;
    ...
    ///         the Shader Resource Binding object. Static variables are accessed through the Shader
    ///         object.
    VIRTUAL Uint32 METHOD(GetVariableCount)(THIS) CONST PURE;
    ...
    ///       no effect and a warning messge will be displayed.
    VIRTUAL void METHOD(InitializeStaticResources)(THIS_
                                                   const struct IPipelineState2* pPipelineState DEFAULT_VALUE(nullptr)) PURE;
};
DILIGENT_END_INTERFACE
...
#    define IShaderResourceBinding2_GetPipelineState(This)               CALL_IFACE_METHOD(ShaderResourceBinding2, GetPipelineState,          This)
#    define IShaderResourceBinding2_BindResources(This, ...)             CALL_IFACE_METHOD(ShaderResourceBinding2, BindResources,             This, __VA_ARGS__)
#    define IShaderResourceBinding2_GetVariableByName(This, ...)         CALL_IFACE_METHOD(ShaderResourceBinding2, GetVariableByName,         This, __VA_ARGS__)
#    define IShaderResourceBinding2_GetVariableCount(This)               CALL_IFACE_METHOD(ShaderResourceBinding2, GetVariableCount,          This)
#    define IShaderResourceBinding2_GetVariableByIndex(This, ...)        CALL_IFACE_METHOD(ShaderResourceBinding2, GetVariableByIndex,        This, __VA_ARGS__)
#    define IShaderResourceBinding2_InitializeStaticResources(This, ...) CALL_IFACE_METHOD(ShaderResourceBinding2, InitializeStaticResources, This, __VA_ARGS__)
