...
DILIGENT_TYPED_ENUM(RENDER_DEVICE_TYPE_FLAGS, Uint32)
{
    RENDER_DEVICE_TYPE_FLAG_NONE   = 0u,                                ///< Undefined device
    RENDER_DEVICE_TYPE_FLAG_D3D11  = 1u << RENDER_DEVICE_TYPE_D3D11,    ///< D3D11 device
    RENDER_DEVICE_TYPE_FLAG_D3D12  = 1u << RENDER_DEVICE_TYPE_D3D12,    ///< D3D12 device
    RENDER_DEVICE_TYPE_FLAG_GL     = 1u << RENDER_DEVICE_TYPE_GL,       ///< OpenGL device
    RENDER_DEVICE_TYPE_FLAG_GLES   = 1u << RENDER_DEVICE_TYPE_GLES,     ///< OpenGLES device
    RENDER_DEVICE_TYPE_FLAG_VULKAN = 1u << RENDER_DEVICE_TYPE_VULKAN,   ///< Vulkan device
    RENDER_DEVICE_TYPE_FLAG_METAL  = 1u << RENDER_DEVICE_TYPE_METAL,    ///< Metal device
    RENDER_DEVICE_TYPE_FLAG_LAST   = RENDER_DEVICE_TYPE_FLAG_METAL
};
DEFINE_FLAG_ENUM_OPERATORS(RENDER_DEVICE_TYPE_FLAGS)
