...
DILIGENT_BEGIN_INTERFACE(IDeviceContext, IObject)
{
    ...
    VIRTUAL void METHOD(SetPipelineState2)(THIS_
                                           IPipelineState2* pPipelineState) PURE;
    ...
    VIRTUAL void METHOD(CommitShaderResources2)(THIS_
                                                IShaderResourceBinding2*        pShaderResourceBinding,
                                                RESOURCE_STATE_TRANSITION_MODE StateTransitionMode) PURE;
