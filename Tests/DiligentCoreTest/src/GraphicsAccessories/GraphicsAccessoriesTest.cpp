...
{
    static_assert(PIPELINE_RESOURCE_FLAG_LAST == (1u << 6), "Please add a test for the new flag here");
    ...
    EXPECT_STREQ(GetPipelineResourceFlagsString(PIPELINE_RESOURCE_FLAG_VULKAN_PUSH_CONSTANT, true).c_str(), "PIPELINE_RESOURCE_FLAG_VULKAN_PUSH_CONSTANT");
    ...
    EXPECT_STREQ(GetPipelineResourceFlagsString(PIPELINE_RESOURCE_FLAG_VULKAN_PUSH_CONSTANT).c_str(), "VULKAN_PUSH_CONSTANT");
