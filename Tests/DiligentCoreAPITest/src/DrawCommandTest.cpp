...
TEST_F(DrawCommandTest, DeferredContexts)
{
    ...
    StateTransitionDesc Barriers[] = //
        {
            {pVB, RESOURCE_STATE_UNKNOWN, RESOURCE_STATE_VERTEX_BUFFER, RESOURCE_STATE_FLAG_UPDATE_STATE},
            {pIB, RESOURCE_STATE_UNKNOWN, RESOURCE_STATE_INDEX_BUFFER, RESOURCE_STATE_FLAG_UPDATE_STATE} //
        };
