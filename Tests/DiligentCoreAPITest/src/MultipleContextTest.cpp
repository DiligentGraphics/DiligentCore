...
TEST_F(MultipleContextTest, GraphicsAndComputeQueue)
{
    ...
    // Draw reference in single queue
    {
        ...
        // blend pass
        {
            ...
            StateTransitionDesc Barrier{pRTV->GetTexture(), RESOURCE_STATE_UNKNOWN, RESOURCE_STATE_COPY_SOURCE, RESOURCE_STATE_FLAG_UPDATE_STATE};
    ...
    // blend and present
    {
        ...
        const StateTransitionDesc Barriers[] = {
            {pRTV->GetTexture(), RESOURCE_STATE_UNKNOWN, RESOURCE_STATE_RENDER_TARGET, RESOURCE_STATE_FLAG_UPDATE_STATE}, // prev_state -> render_target
