...
void MeshShaderDrawReferenceD3D12(ISwapChain* pSwapChain)
{
    ...
    auto hr = CompileDXILShader(HLSL::MeshShaderTest_MS, L"main", {}, L"ms_6_5", &pMSByteCode);
    ASSERT_HRESULT_SUCCEEDED(hr) << "Failed to compile mesh shader";

    hr = CompileDXILShader(HLSL::MeshShaderTest_PS, L"main", {}, L"ps_6_5", &pPSByteCode);
...
void AmplificationShaderDrawReferenceD3D12(ISwapChain* pSwapChain)
{
    ...
    auto hr = CompileDXILShader(HLSL::AmplificationShaderTest_AS, L"main", {}, L"as_6_5", &pASByteCode);
    ASSERT_HRESULT_SUCCEEDED(hr) << "Failed to compile amplification shader";

    hr = CompileDXILShader(HLSL::AmplificationShaderTest_MS, L"main", {}, L"ms_6_5", &pMSByteCode);
    ASSERT_HRESULT_SUCCEEDED(hr) << "Failed to compile mesh shader";

    hr = CompileDXILShader(HLSL::AmplificationShaderTest_PS, L"main", {}, L"ps_6_5", &pPSByteCode);
    ASSERT_HRESULT_SUCCEEDED(hr) << "Failed to compile pixel shader";
