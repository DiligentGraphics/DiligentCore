...
TEST(ResourceStateTest, DiscardContent)
{
    ...
    TextureDesc TexDesc;
    TexDesc.Name      = "DiscardContent test texture";
    ...
    const StateTransitionDesc Barrier{pTexture, RESOURCE_STATE_UNKNOWN, RESOURCE_STATE_UNORDERED_ACCESS, RESOURCE_STATE_FLAG_UPDATE_STATE | RESOURCE_STATE_FLAG_DISCARD_CONTENT};
