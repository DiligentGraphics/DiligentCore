...
namespace RenderStateCacheTests
{
...
{
    RenderStateCacheTests::TestCaches(/*CompileAsync = */ false);
}

TEST(RenderStateCacheTest, SpecializationConstants_Async)
{
    RenderStateCacheTests::TestCaches(/*CompileAsync = */ true);
}

TEST(RenderStateCacheTest, SpecializationConstants_DistinctEntries)
{
    RenderStateCacheTests::TestDistinctEntries(/*CompileAsync = */ false);
}

TEST(RenderStateCacheTest, SpecializationConstants_DistinctEntries_Async)
{
    RenderStateCacheTests::TestDistinctEntries(/*CompileAsync = */ true);
}
