...
function(find_windows_sdk)
    ...
    set(DILIGENT_DXC_DIR "" CACHE PATH "Optional DXC bin directory that contains dxcompiler.dll and dxil.dll")
    if(DILIGENT_DXC_DIR)
        file(TO_CMAKE_PATH "${DILIGENT_DXC_DIR}" DILIGENT_DXC_DIR_NORMALIZED)
        if(EXISTS "${DILIGENT_DXC_DIR_NORMALIZED}/dxcompiler.dll" AND EXISTS "${DILIGENT_DXC_DIR_NORMALIZED}/dxil.dll")
            set(DXC_COMPILER_PATH "${DILIGENT_DXC_DIR_NORMALIZED}/dxcompiler.dll")
            set(DXIL_SIGNER_PATH  "${DILIGENT_DXC_DIR_NORMALIZED}/dxil.dll")
        else()
            message(WARNING "DILIGENT_DXC_DIR does not contain dxcompiler.dll and dxil.dll: ${DILIGENT_DXC_DIR_NORMALIZED}")
        endif()
    endif()
