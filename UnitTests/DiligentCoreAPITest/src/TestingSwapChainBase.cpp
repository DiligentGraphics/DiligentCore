...
#if VULKAN_SUPPORTED
void CreateTestingSwapChainVk(IRenderDevice*       pDevice,
                              IDeviceContext*      pContext,
                              const SwapChainDesc& SCDesc,
                              ISwapChain**         ppSwapChain);
#endif
                            ...
                            ISwapChain**         ppSwapChain)
{
    ...
    switch (deviceType)
    {
        ...
        case DeviceType::D3D11:
            CreateTestingSwapChainD3D11(pDevice, pContext, SCDesc, ppSwapChain);
            break;
#endif

#if D3D12_SUPPORTED
        case DeviceType::D3D12:
            CreateTestingSwapChainD3D12(pDevice, pContext, SCDesc, ppSwapChain);
            break;
#endif
        ...
        case DeviceType::OpenGLES:
            CreateTestingSwapChainGL(pDevice, pContext, SCDesc, ppSwapChain);
            break;
        ...
        case DeviceType::Vulkan:
            CreateTestingSwapChainVk(pDevice, pContext, SCDesc, ppSwapChain);
            break;
